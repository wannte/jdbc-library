...
import jdbc.utils.DataAccessUtils;
...
public class JdbcTemplate {
    ...
    public <T> List<T> query(final PreparedStatementCreator psc, final ResultSetExtractor<List<T>> rse)
            throws DataAccessException {
    ...
    public <T> List<T> query(final String sql, final ResultSetExtractor<List<T>> rse, final Object... args)
            throws DataAccessException {
